...
<body>
    ...
    <section class="section" id="about">
        <div class="container">
            ...
            <p>My practical experience includes participation in the prestigious Investment Strategy Challenge held by Natixis CIB, where I collaborated with team members to develop and optimize investment portfolios under dynamic market conditions. This hands-on competition enhanced my understanding of risk-return tradeoffs, asset allocation strategies, and performance measurement techniques.</p>
        </div>
    </section>
